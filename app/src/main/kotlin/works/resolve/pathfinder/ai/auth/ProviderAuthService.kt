...
class ProviderAuthService(
     ...
     * see [works.resolve.pathfinder.ai.providers.filterCatalogModels]) — static
     ...
     * `Models.login`). Diagnostics (the `pf.auth.login` span) live at the
     * Android caller boundary in `PathfinderDiagnostics`, not in this ported
     * service — pi's Models.login takes no telemetry context.
     *
