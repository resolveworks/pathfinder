...
import works.resolve.distill.ai.auth.oauth.UrlConnectionOAuthHttpClient
 ...
 * flows directly inside its provider definitions; Distill composes them
...
object ProductionCatalogAuthRegistry : CatalogAuthRegistry {
    ...
    override fun oauthAuth(provider: works.resolve.distill.ai.providers.CatalogProvider): OAuthAuth? {
