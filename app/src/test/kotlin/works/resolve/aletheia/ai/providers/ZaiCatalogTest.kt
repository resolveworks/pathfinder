...
import works.resolve.aletheia.ai.core.clampThinkingLevel
import works.resolve.aletheia.ai.core.getSupportedThinkingLevels
...
class ZaiCatalogTest {
    ...
    fun `provider factory wires identity catalog and api`() {
        ...
        assertTrue(provider.api is works.resolve.aletheia.ai.api.OpenAiCompletionsApi)
    }
