...
class ConversationTest {
    ...
    private fun List<works.resolve.distill.ai.core.Message>.texts(): List<String> =
        map { (it as UserMessage).content.single().let { (it as works.resolve.distill.ai.core.TextContent).text } }
}
